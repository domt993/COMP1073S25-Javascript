...
async function populate() {
    ...
    const url = 'https://domt993.github.io/COMP1073S25-Javascript/lesson-10/js/i-scream.json';
...
function populateHeader(jsonBody) {
    ...
    p.textContent= `Head Office ${jsonBody.headOffice}, established in ${jsonBody.established} - Active: ${jsonBody.active ? "Yes" : "No"}`
...
function showTopFlavors(jsonBody) {
    ...
    for (let i = 0; i < topFlavors.length; i ++) {
        ...
        p3.textContent = `Size: ${topFlavors[i].size}`;
