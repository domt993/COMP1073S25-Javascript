...
function setWeather() {
	...
	if (choice === 'sunny') {
		...
		comments.textContent = 'It is sunny out there, today!';
	}
	else if (choice === 'rainy') {
		icon.src = 'images/rainy.svg';
		comments.textContent = 'It is rainy out there, today!';
	}
	else if (choice === 'windy') {
		icon.src = 'images/windy.svg';
		comments.textContent = 'It is windy out there, today!';
	}
	else {
...
// STEP 5b: Build out four cases, followed by a default
	...
	case 25:
		...
		break;
	default:
		windComment.textContent = 'No wind today!'
}
...
breakMessage.textContent = coffeeBreak ? 'Time for a coffee break!' : 'Keep working hard!';
